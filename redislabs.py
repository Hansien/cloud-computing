...
redis1.set('Change Language', 'Please input language code to select your language:🇨🇳: CH, 🇺🇸:EN, you can find other language code in https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes!')
